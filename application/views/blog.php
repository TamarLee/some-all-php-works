...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<ul class="breadcrumb">
				<li><a href="<?=base_url();?>Home/index"><i class="fa fa-home"></i></a><i class="icon-angle-right"></i></li>
				<li class="active">ბლოგი</li>
			</ul>
		</div>
	</div>
</div>
		...
		<div class="col-lg-8">
			<article>
					<div class="post-image">
						...
						<img src="<?=base_url();?>img/dummies/blog/img1.jpg" alt="" />
					</div>
					<p>
					...
					<div class="post-slider">
						...
						<div id="post-slider" class="flexslider">
							<ul class="slides">
								...
								<li>
								<img src="<?=base_url();?>img/dummies/blog/img2.jpg" alt="" />
								</li>
								<li>
								<img src="<?=base_url();?>img/dummies/blog/img3.jpg" alt="" />
								</li>
							</ul>
						</div>
						<!-- end flexslider -->
		...
		<div class="col-lg-4">
			...
			<div class="widget">
				<form class="form-search">
					<input class="form-control" type="text" placeholder="ძიება">
				</form>
			</div>
			<div class="widget">
			...
			<div class="widget">
				...
				<ul class="recent">
					<li>
					<img src="<?=base_url();?>img/dummies/blog/65x65/thumb1.jpg" class="pull-left" alt="" />
					...
					<li>
					<a href="#"><img src="<?=base_url();?>img/dummies/blog/65x65/thumb2.jpg" class="pull-left" alt="" /></a>
					...
					<li>
					<a href="#"><img src="<?=base_url();?>img/dummies/blog/65x65/thumb3.jpg" class="pull-left" alt="" /></a>
